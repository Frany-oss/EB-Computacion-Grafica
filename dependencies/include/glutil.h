...
GLFWwindow* glutilInit(i32 major, i32 minor, i32 width, i32 height,	const i8* title, i32 screenWidth = 1366, i32 screenHeight = 768) {
	glfwInit();
...
public:
	Shader(std::string shadersPath = "bin", std::string texturesPath = "resources/textures",
		std::string vertexFileName = "shader.vert", std::string fragmentFileName = "shader.frag")
